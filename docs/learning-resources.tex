...
Python, pandas, quantitative indicators, APIs.
...
\midrule
\endhead
  Financial Engineering and Risk Management & \href{https://www.coursera.org/specializations/financialengineering}{\texttt{link}} & Quantitative finance and screening rules. \\
\bottomrule
\caption{Coursera}
\end{longtable}
...
\midrule
\endhead
  Data Analysis with pandas & \href{https://www.pluralsight.com/courses/data-analysis-pandas}{\texttt{link}} & Indicator calculations. \\
\bottomrule
\caption{Pluralsight}
\end{longtable}
...
\begin{itemize}[leftmargin=1.5em]
  \item \href{https://github.com/twopirllc/pandas-ta}{\textbf{twopirllc/pandas-ta}} — Technical analysis metrics.
\end{itemize}
