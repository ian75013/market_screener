...
technologies used in \textbf{Market Screener}.
...
Python, pandas, SQL, basic technical analysis knowledge.
...
\midrule
\endhead
  Introduction to Portfolio Construction and Analysis with Python & \href{https://www.coursera.org/learn/introduction-portfolio-construction-python}{\texttt{link}} & Portfolio statistics, risk metrics, technical analysis in Python. \\
  Financial Engineering and Risk Management & \href{https://www.coursera.org/specializations/financialengineering}{\texttt{link}} & Quantitative finance foundations for screener rule design. \\
\bottomrule
\caption{Coursera}
\end{longtable}
...
\midrule
\endhead
  Data Analysis with pandas & \href{https://www.pluralsight.com/courses/data-analysis-pandas}{\texttt{link}} & DataFrame operations used extensively for indicator calculation. \\
\bottomrule
\caption{Pluralsight}
\end{longtable}
...
\begin{itemize}[leftmargin=1.5em]
  \item \href{https://github.com/twopirllc/pandas-ta}{\textbf{twopirllc/pandas-ta}} — Technical analysis library used for indicator calculation.
  \item \href{https://github.com/ranaroussi/yfinance}{\textbf{ranaroussi/yfinance}} — Yahoo Finance connector used as primary data source.
\end{itemize}

\section{Reference Books}
\begin{itemize}[leftmargin=1.5em]
  \item \href{https://www.oreilly.com/library/view/python-for-finance/9781492024323/}{\textit{Python for Finance}} — Yves Hilpisch, 2nd ed.. Pandas, NumPy, data visualisation for financial data.
\end{itemize}
